...
// This test reproduces https://github.com/expanse-org/go-expanse/issues/17837 where the
...
// It is the reproducer for https://github.com/expanse-org/go-expanse/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-expanse-test-ipc-%d-%d", os.Getpid(), rand.Int63())
