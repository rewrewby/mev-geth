...
import (
	...
	"github.com/expanse-org/go-expanse/crypto/signify"
...
// Files that end up in the gexp-alltools*.zip archive.
	...
	debExecutables = []debExecutable{
		...
		{
			BinaryName:  "clef",
			Description: "Expanse account management tool.",
		},
	}
...
func doAndroidArchive(cmdline []string) {
	...
	if *local {
		...
		os.Rename("gexp-sources.jar", filepath.Join(GOBIN, "gexp-sources.jar"))
		return
	}
...
func doXCodeFramework(cmdline []string) {
	...
	if *deploy != "" {
		...
		build.MustRunCommand("pod", *deploy, "push", "Gexp.podspec", "--allow-warnings")
	}
}
