...
import (
	...
	sv "github.com/expanse-org/go-expanse/swarm/version"
)
...
// Files that end up in the gexp-alltools*.zip archive.
	...
	debExecutables = []debExecutable{
		...
		{
			BinaryName:  "wnode",
			Description: "Expanse Whisper diagnostic tool",
		},
	}
...
func doInstall(cmdline []string) {
	...
	if !strings.Contains(runtime.Version(), "devel") {
		...
		if minor < 9 {
			...
			log.Println("go-expanse requires at least Go version 1.9 and cannot")
...
func doArchive(cmdline []string) {
	...
	for _, archive := range []string{gexp, alltools, swarm} {
...
func doDebianSource(cmdline []string) {
	var (
		...
		upload  = flag.String("upload", "", `Where to upload the source package (usually "expanse/expanse")`)
		sshUser = flag.String("sftp-user", "", `Username for SFTP upload (usually "gexp-ci")`)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/expanse-org/go-expanse/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/expanse-org/go-expanse/mobile")
