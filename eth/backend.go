...
import (
	...
	"github.com/expanse-org/go-expanse/core/state/pruner"
	"github.com/expanse-org/go-expanse/core/types"
	"github.com/expanse-org/go-expanse/core/vm"
	"github.com/expanse-org/go-expanse/eth/downloader"
	"github.com/expanse-org/go-expanse/eth/ethconfig"
	"github.com/expanse-org/go-expanse/eth/filters"
	"github.com/expanse-org/go-expanse/eth/gasprice"
	"github.com/expanse-org/go-expanse/eth/protocols/eth"
	"github.com/expanse-org/go-expanse/eth/protocols/snap"
...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	log.Info("Initialising Expanse protocol", "network", config.NetworkId, "dbversion", dbVer)

	if !config.SkipBcVersionCheck {
		if bcVersion != nil && *bcVersion > core.BlockChainVersion {
			return nil, fmt.Errorf("database version is v%d, Gexp %s only supports v%d", *bcVersion, params.VersionWithMeta, core.BlockChainVersion)
